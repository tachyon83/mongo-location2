...
router.get('/:pageNo/:numOfRows/:mapX/:mapY/:radius', (req, res) => {
    ...
    request({
        ...
        // console.log('objKeys', Object.keys(converted.response.body.items.item[0]))
        converted.response.body.items.item.map(e => {
            console.log('objKeys', Object.keys(e))
            // console.log(e.contentId)
            // console.log(e.facltNm)
            // console.log(e.lineIntro)
            // console.log(e.intro)
            // console.log(e.hvofBgnde)
            // console.log(e.hvofEnddle)
            // console.log(e.featureNm)
            // console.log(e.induty)
            // console.log(e.lctCl)
            // console.log(e.doNm)
            // console.log(e.sigunguNm)
            // console.log(e.addr1)
            // console.log(e.addr2)
            // console.log(e.mapX)
            // console.log(e.mapY)
            ...
            // console.log(e.exprnProgrm)
            // console.log(e.eqpmnLendCl)
            // console.log(e.animalCmgCl)
            // console.log(e.tourEraCl)
            // console.log(e.firstImageUrl)
        })
